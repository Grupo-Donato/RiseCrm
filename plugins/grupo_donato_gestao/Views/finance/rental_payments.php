...
$turmas_pagamento = [["id" => "", "text" => "Todas as quadras"]];
...
<div class="p20">
    ...
    <div class="gd-mobile-filter-panel p15 mb15">
        <div class="row">
            ...
            <div class="col-sm-6">
                <label for="bombeiros-pagamentos-mobile-turma">Quadra</label>
...
<script type="text/javascript">
    window.initBombeirosPagamentosTable = function () {
        ...
        if (!$.fn.DataTable.isDataTable("#bombeiros-pagamentos-table")) {
            ...
            $("#bombeiros-pagamentos-table").appTable({
                source: "<?php echo_uri("grupo_donato/finance/rental-payments/data"); ?>",
                order: [[1, "asc"]],
                stateSave: false,
    ...
    $(document).ready(function () {
        ...
        window.reloadBombeirosPagamentosResumo = function () {
            appAjaxRequest({
                url: "<?php echo_uri("grupo_donato/finance/rental-payments/summary"); ?>",
                type: "POST",
                dataType: "json",
                data: {
        ...
        $("body").off("click", "#bombeiros-gerar-cobrancas-mes").on("click", "#bombeiros-gerar-cobrancas-mes", function () {
            ...
            appAjaxRequest({
                url: "<?php echo_uri("grupo_donato/finance/rental-payments/generate"); ?>",
                type: "POST",
                dataType: "json",
                data: {
                    mes_referencia: getPagamentoFilterValue("mes_referencia", "<?php echo (int) date("m"); ?>"),
        ...
        $("body").off("click", ".gd-rental-create-charge").on("click", ".gd-rental-create-charge", function () {
            ...
            appAjaxRequest({
                url: "<?php echo_uri("grupo_donato/finance/rental-payments/create-rental-charge"); ?>",
                type: "POST",
                dataType: "json",
                data: {
