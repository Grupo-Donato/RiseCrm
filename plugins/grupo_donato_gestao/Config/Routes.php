...
$routes->group("grupo_donato", ["namespace" => "grupo_donato_gestao\\Controllers", "filter" => "csrf"], function ($routes) {
    ...
    $routes->post("court-rentals/availability-options", "Court_rentals::availability_options");
    $routes->post("court-rentals/barbecue-availability-options", "Court_rentals::barbecue_availability_options");
    $routes->post("court-rentals/recurring-availability", "Court_rentals::recurring_availability");
    $routes->post("court-rentals/reschedule-modal", "Court_rentals::reschedule_modal");
    $routes->post("court-rentals/reschedule-availability", "Court_rentals::reschedule_availability");
    $routes->post("court-rentals/reschedule-resource-options", "Court_rentals::reschedule_resource_options");
    $routes->post("court-rentals/reschedule", "Court_rentals::reschedule");
    $routes->post("court-rentals/reschedule/revert", "Court_rentals::revert_reschedule");
    ...
    // Custos é a fonte única de verdade para saídas operacionais.
    $routes->get("finance/costs", "Costs::index");
    $routes->post("finance/costs/data", "Costs::data");
    $routes->post("finance/costs/modal", "Costs::modal");
    $routes->post("finance/costs/save", "Costs::save");
    $routes->post("finance/costs/view", "Costs::view");
    $routes->post("finance/costs/payment-modal", "Costs::payment_modal");
    ...
    $routes->post("finance/costs/categories/modal", "Costs::category_modal");
    $routes->post("finance/costs/categories/save", "Costs::category_save");
    $routes->post("finance/costs/recurrences/data", "Costs::recurrences_data");
    $routes->post("finance/costs/recurrences/modal", "Costs::recurrence_modal");
    $routes->post("finance/costs/recurrences/save", "Costs::recurrence_save");
    $routes->post("finance/costs/recurrences/generate", "Costs::recurrence_generate");
    $routes->post("finance/costs/budgets/data", "Costs::budgets_data");
    $routes->post("finance/costs/budgets/modal", "Costs::budget_modal");
    $routes->post("finance/costs/budgets/save", "Costs::budget_save");
    $routes->post("finance/costs/attachments/upload", "Costs::attachment_upload");
    $routes->post("finance/costs/attachments/delete", "Costs::attachment_delete");
    $routes->get("finance/costs/attachments/(:num)", "Costs::attachment_download/$1");
    // Aliases legados: mantêm bookmarks e integrações sem uma segunda tela.
    $routes->get("finance/expenses", "Costs::legacy_redirect");
    $routes->post("finance/expenses/data", "Costs::data");
    $routes->post("finance/expense-modal", "Costs::modal");
    $routes->post("finance/expenses/save", "Costs::save");
