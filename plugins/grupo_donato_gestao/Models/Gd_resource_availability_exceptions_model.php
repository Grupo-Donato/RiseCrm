...
class Gd_resource_availability_exceptions_model extends Gd_resource_temporal_model
{
    protected array $searchable_fields = ["title", "reason"];
    public function __construct() { parent::__construct("gd_resource_availability_exceptions"); }
    ...
    public function get_details(array $options=[]):array{return $this->temporal_details($options,["exception_type","status"],["starts_at_utc"=>"starts_at_utc","title"=>"title","status"=>"status","updated_at"=>"updated_at"],["title","reason"]);}
}
