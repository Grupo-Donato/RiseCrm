...
<?php echo form_open(get_uri("grupo_donato/barbecue-rentals/save-single"), ["id" => "gd-court-single-form", "class" => "general-form gd-rentals-shell", "role" => "form"]); ?>
...
$(document).ready(function(){
    ...
    gdRentalSelect($("#gd-cr-product"), '<?php echo_uri("grupo_donato/barbecue-rentals/product-options"); ?>');
    gdRentalSelect($("#gd-cr-price-list"), '<?php echo_uri("grupo_donato/barbecue-rentals/price-list-options"); ?>');
    ...
    checkButton.on("click", function(){
        ...
        $.ajax({
            url: '<?php echo_uri("grupo_donato/barbecue-rentals/check-availability"); ?>',
            type: "POST",
            data: payload,
            dataType: "json"
