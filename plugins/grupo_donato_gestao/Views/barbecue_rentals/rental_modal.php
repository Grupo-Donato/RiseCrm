...
$edit_endpoint = $edit_type === "single" ? "grupo_donato/barbecue-rentals/update-single" : "grupo_donato/barbecue-rentals/update-monthly";
...
$messages = [
    "resource_required" => app_lang("gd_select_at_least_one_barbecue"),
    ...
    "available_courts_help" => app_lang("gd_available_barbecues_help"),
    "no_courts" => app_lang("gd_no_barbecues_available_for_time"),
];
$time_options = [];
...
?>
<?php echo form_open(get_uri($is_edit ? $edit_endpoint : "grupo_donato/barbecue-rentals/save-rental"), ["id" => "gd-rental-form", "class" => "general-form", "role" => "form"]); ?>
<?php if ($is_edit) { ?>
...
<div class="modal-body clearfix">
    <div class="container-fluid">
        ...
        <div class="mb20">
            <h5 class="mb15"><?php echo app_lang("gd_select_barbecue"); ?></h5>
            <?php if ($resources) { ?>
                <div class="form-group mb0">
...
$(document).ready(function(){
    var form = $("#gd-rental-form"),
        ...
        modeHelp = {
            single: <?php echo json_encode(app_lang("gd_barbecue_rental_mode_single_help")); ?>,
            recurring: <?php echo json_encode(app_lang("gd_barbecue_rental_mode_recurring_help")); ?>
        },
        checkTimer = null,
    ...
    function loadAvailableCourts() {
        ...
        availableCourtsXhr = $.ajax({
            url: '<?php echo_uri("grupo_donato/barbecue-rentals/availability-options"); ?>',
            type: "POST",
            data: $.param(data),
            dataType: "json"
    ...
    function validationMessage() {
        if (!$.trim(customer.val())) { return <?php echo json_encode(app_lang("gd_barbecue_customer_required")); ?>; }
    ...
    function checkAvailability() {
        ...
        $.ajax({
            url: currentMode === "recurring" ? '<?php echo_uri("grupo_donato/barbecue-rentals/preview"); ?>' : '<?php echo_uri("grupo_donato/barbecue-rentals/check-availability"); ?>',
            type: "POST",
            data: $.param(data),
            dataType: "json"
        }).done(function(response){
    ...
    form.appForm({
        ...
        onSuccess: function(response){
            ...
            else { location.href = '<?php echo_uri("grupo_donato/barbecue-rentals/view/"); ?>' + response.id; }
        }
    });
