...
<?php echo form_open(get_uri("grupo_donato/barbecue-rentals/save-monthly"), ["id" => "gd-court-monthly-form", "class" => "general-form gd-rentals-shell", "role" => "form"]); ?>
...
<div class="modal-body clearfix">
    <div class="container-fluid">
        ...
        <div class="gd-section-title"><i data-feather="grid" class="icon-18"></i><h5><?php echo app_lang("gd_select_barbecues"); ?></h5></div>
        <?php if ($resources) { ?>
            <div class="row">
...
$(document).ready(function(){
    ...
    form.appForm({onSuccess:function(response){
        location.href = '<?php echo_uri("grupo_donato/barbecue-rentals/view/"); ?>' + response.id;
    }});

    customer.select2({
        placeholder: "-", allowClear: true, width: "100%",
        ajax: {
            url: '<?php echo_uri("grupo_donato/barbecue-rentals/customer-options"); ?>', type: "POST", dataType: "json", delay: 250,
    ...
    contact.select2({
        placeholder: "-", allowClear: true, width: "100%",
        ajax: {
            url: '<?php echo_uri("grupo_donato/barbecue-rentals/contact-options"); ?>', type: "POST", dataType: "json", delay: 250,
    ...
    gdRentalSelect($("#gd-crm-product"), '<?php echo_uri("grupo_donato/barbecue-rentals/product-options"); ?>');
    gdRentalSelect($("#gd-crm-price-list"), '<?php echo_uri("grupo_donato/barbecue-rentals/price-list-options"); ?>');
    ...
    $("#gd-crm-preview").on("click", function(){
        ...
        $.ajax({
            url: '<?php echo_uri("grupo_donato/barbecue-rentals/preview"); ?>',
            type: "POST",
            data: form.serialize(),
            dataType: "json"
    ...
    $("#gd-crm-resolve").on("click", function(){
        $.ajax({
            url: '<?php echo_uri("grupo_donato/barbecue-rentals/resolve-price"); ?>',
            type: "POST",
            dataType: "json",
            data: {
